...
export async function load(session, kitConfig) {
    ...
    kit.command = kit.command ?? `talkpile`;
    kit.name = kit.name ?? `Talkpile`;
    kit.description = kit.description ?? `Talkpile team leader, and the user's primary interface to the Talkpile system.`;
    kit.identity = kit.identity ??
