...
export async function load(session, agentConfig) {
    ...
    agent.designation = agent.designation ?? `talkpile`;
    agent.name = agent.name ?? `Talkpile`;
    agent.description = agent.description ?? `Talkpile team leader, and the user's primary interface to the Talkpile system.`;
