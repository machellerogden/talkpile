...
export function truncateChatCompletion(request, preludeLength = 0, limit = null) {
    limit = limit ?? getModelLimit(request.model);
...
//console.log(truncateChatCompletion(exampleRequest, 2));
//console.log(truncateChatCompletion(exampleRequest, 1));
