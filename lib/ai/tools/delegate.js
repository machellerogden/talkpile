    ...
    parameters: {
        ...
        properties: {
            message: {
                ...
                default: `This message is from your teammate: ${agent.designation}. Messages after this first message will be from the user: ${session.config.name}. I'm delegating control of this user session to you temporarily. When you end the conversation it will return to me. The user would like to know today's weather forecast for Chicago, IL. Please assist with this request.`
            },
            team_member: {
                type: 'string',
