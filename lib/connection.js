...
export function sendSystemRequest(connection, message) {
    return send(connection, message, { system: true, quiet: true });
}

export function sendContextRequest(connection, message) {
    return send(connection, message, { contextRequest: true, quiet: true  });
}
